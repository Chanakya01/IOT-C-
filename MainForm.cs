    ...
    public partial class FrmPrincipal : Form
    {
        ...
        void Display(string s)
        {
            ...
            try
            {
                ...
                if (en > 40)
                {
                    EmailSend.SendMail("bsljjyothi@gmail.com", "Fire at home Alarm","Fire at Home Alarm "+DateTime.Now ,"");
                }
        ...
        private void btnLock_Click(object sender, EventArgs e)
        {
            ...
            {
                //// Send a Mail
                (new System.Speech.Synthesis.SpeechSynthesizer()).SpeakAsync("Unauthorized Attempt!!! please Contact Chanakya");

                String fileName = ".\\Unknown\\Image_" + DateTime.Now.ToString("yyyyMMdd_hhmmss") + ".jpg";//Save the filename first on 


                imageBoxFrameGrabber.Image.Save(fileName);
                EmailSend.SendMail("bsljjyothi@gmail.com", "Unknown Person", "Unknown person attempting unlock " + DateTime.Now, fileName);
                ///////
            }
